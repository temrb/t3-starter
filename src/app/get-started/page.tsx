	...
	return (
		<div className='h-full w-full'>
			<div className='flex h-full w-full items-center justify-center p-2'>
				<Card className='mx-auto w-full max-w-md transform transition-shadow duration-500 ease-in-out hover:shadow-2xl'>
					<CardHeader className='flex items-center justify-start space-y-2 border-b-[1px] border-b-foreground/10'>
						<Logo size='lg' />
